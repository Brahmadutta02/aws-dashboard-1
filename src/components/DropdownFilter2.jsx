    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <svg className="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                  ...
                  <span className="hidden xs:block ml-2">New URL</span>
      </button>
      <Transition
        show={dropdownOpen}
        tag="div"
...
<div style={{ fontFamily: 'Arial, sans-serif', padding: '20px', border: '1px solid #ccc', borderRadius: '5px', maxWidth: '300px', margin: '0 auto' }}>
    <form >
        <input 
    ...
    <p style={{ fontSize: '14px',  }}>Your Video is Processing...</p>
</div>
