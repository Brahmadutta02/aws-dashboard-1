...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  const [openTrendingHashtags, setOpenTrendingHashtags] = useState(false);
  const [openContentSuggestions, setOpenContentSuggestions] = useState(false);
  const [openMetaDataSuggestions, setOpenMetaDataSuggestions] = useState(false);
  ...
  const handleTrendingHashtagsClick = () => {
    setOpenTrendingHashtags(!openTrendingHashtags);
  };

  const handleContentSuggestionsClick = () => {
    setOpenContentSuggestions(!openContentSuggestions);
  };

  const handleMetaDataSuggestionsClick = () => {
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <SidebarLinkGroup
                activecondition={
                  pathname === "/" || pathname.includes("dashboard") || pathname.includes("recommendation")
                }
              >
                {(handleClick, open) => {
                  return (
                                          ...
                                          >
                                            <li className="mb-1 last:mb-0">
                                              <NavLink
                                                ...
                                                to="/recommendation/trending-hashtags"
                                                className={({ isActive }) =>
                                                  "block transition duration-150 truncate " +
                                                  (isActive
                                                    ? "text-indigo-500"
                                            ...
                                            <NavLink
                                              ...
                                              to="/recommendation/content-suggestions" // Absolute path
                                              className={({ isActive }) =>
                                                "block transition duration-150 truncate " +
                                                (isActive
                                                  ? "text-indigo-500"
                                            ...
                                            <NavLink
                                              ...
                                              to="/recommendation/meta-data-suggestions" // Absolute path
                                              className={({ isActive }) =>
                                                "block transition duration-150 truncate " +
                                                (isActive
                                                  ? "text-indigo-500"
                  ...
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 truncate transition duration-150 ${
                          (pathname.includes("settings")&& sidebarExpanded)
