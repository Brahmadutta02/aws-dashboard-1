...
function CustomersTable({ selectedItems }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 relative">
      <div>
        {/* New URL input */}
        <form onSubmit={handleUrlSubmit} className="flex justify-end mt-4" style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '0px', position:'relative', bottom:'60px', right:'2px' }}>
          <input
            type="text"
            value={newUrl}
