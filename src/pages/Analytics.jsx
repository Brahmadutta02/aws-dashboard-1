    ...
    async function fetchTokenAndEmbedDashboard() {
      try {
        ...
        const loginResponse = await fetch(
          "https://bunny-discrete-strictly.ngrok-free.app/api/v1/security/login",
          {
            method: "POST",
            headers: {
        ...
        const guestTokenResponse = await fetch(
          "https://bunny-discrete-strictly.ngrok-free.app/api/v1/security/guest_token",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
        ...
        embedDashboard({
          ...
          supersetDomain: "https://bunny-discrete-strictly.ngrok-free.app/", // Superset instance URL
